    ...
    return TouchableOpacity(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          border: border,
          color: onTap != null ? color : PlaneColors.grayStroke,
        ...
        child: Center(
          child: child ??
              Text(
                text!,
                style: PlaneFonts(context).boldQuicksand(size: 14).apply(
                      color: onTap != null
                          ? textColor
                          : PlaneColors.black.withOpacity(0.6),
                    ),
              ),
        ),
      ),
      ...
      child: AnimatedContainer(
        ...
        child: Center(
          ...
          style: PlaneFonts(context).boldQuicksand(
            color: PlaneColors.lightPrimary,
            size: 14,
          ),
        )),
      ),
